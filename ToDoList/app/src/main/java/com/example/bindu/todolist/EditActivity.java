...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tasks t = (Tasks) getIntent().getExtras().get(MainActivity.tasks);
        title.setText(t.getTitle());
        date.setText(t.getDate());
        time.setText(t.getTime());
        RadioButton rb = (RadioButton)findViewById(R.id.radioButtonhigh);
        RadioButton rb1 = (RadioButton)findViewById(R.id.radioButtonlow);
        RadioButton rb2 = (RadioButton)findViewById(R.id.radioButtonmedium);
        if(rb.getText().toString().equals(t.getPriority())){
            rb.setChecked(true);
        }else if(rb1.getText().toString().equals(t.getPriority())){
            rb1.setChecked(true);
        }else if(rb2.getText().toString().equals(t.getPriority())){
            rb2.setChecked(true);
        }
